...
if(!abonerol) return message.channel.send(`Abone rolü ayarlanmamış!`)
  ...
  .setColor(`GOLD`)
  .setFooter(`${client.user.username} | Client Abone Sistemi`)
  .setImage('https://media.discordapp.net/attachments/824219555475619861/933678184203960390/client-scripting.png');
